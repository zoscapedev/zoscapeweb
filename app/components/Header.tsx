        ...
        <div className="flex justify-between items-center h-16 sm:h-20">
          ...
          <Link href="/" className="flex items-center justify-center flex-1 lg:flex-none">
            <div className="relative w-[100px] h-[50px] sm:w-[120px] sm:h-[60px]">
              <Image src="/zoscape.png" alt="Zoscape Logo" fill className="object-contain" />
            </div>
          </Link>

          {/* Contact Details */}
          <div className="flex items-center gap-3 sm:gap-6 lg:w-[200px] lg:justify-end">
            <div className="hidden lg:flex flex-col text-right gap-1">
              ...
              <div className="flex items-center gap-2 justify-end">
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-sm text-black hover:underline">+91 8459074850</a>
              </div>
              <div className="flex items-center gap-2 justify-end">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 text-black">
            ...
            <div className="lg:hidden">
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="text-black font-medium text-xs sm:text-sm bg-white px-3 py-1.5 rounded-lg hover:bg-gray-100 transition-colors">Contact</a>
            </div>
          </div>
        </div>
      </div>
